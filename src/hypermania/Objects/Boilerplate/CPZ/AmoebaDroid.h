...
extern void (*AmoebaDroid_State_DropIn)(void);
extern void (*AmoebaDroid_State_DropIntoPool)(void);
extern void (*AmoebaDroid_State_SurfaceFromPool)(void);
extern void (*AmoebaDroid_State_ChooseAttack)(void);
extern void (*AmoebaDroid_State_ExitPool)(void);
extern void (*AmoebaDroid_State_BounceAttack)(void);
extern void (*AmoebaDroid_State_GatherBlobs)(void);
extern void (*AmoebaDroid_State_SpinBlobs)(void);
extern void (*AmoebaDroid_State_Destroyed)(void);
